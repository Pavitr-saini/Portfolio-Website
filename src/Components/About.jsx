                  ...
                  <div className="flex gap-3 py-4">
                      ...
                      <span className="w-96">
                          ...
                          <p className="text-md md:text-md leading-tight">
                              ...
                              I enjoy building responsive, user-friendly interfaces and improving my problem-solving skills through projects and DSA practice.

                              I have hands-on experience with HTML, CSS, JavaScript, React.js, and Tailwind CSS.
                              Currently improving my skills in React and building real-world projects.
                          </p>
                      </span>
                  </div>
              </div>
